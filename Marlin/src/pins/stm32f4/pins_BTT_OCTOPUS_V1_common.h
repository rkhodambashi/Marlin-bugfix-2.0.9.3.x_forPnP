...
#endif
//======================Roozbeh: added this for J axis==================
#ifdef J_STALL_SENSITIVITY
  #define J_STOP_PIN                  Z2_DIAG_PIN
  #if J_HOME_TO_MIN
  ...
  #ifndef J_MIN_PIN
    #define J_MIN_PIN                 Z2_DIAG_PIN  // Z-STOP
  #endif
  #ifndef J_MAX_PIN
    #define J_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#else
  #define J_STOP_PIN                  J_DIAG_PIN  // J-STOP
#endif
